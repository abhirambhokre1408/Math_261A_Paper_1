---
title: "The More We Sit, the More We Weigh: A County-Level Regression Analysis of Physical Inactivity and Obesity in the U.S."
...
#| warning: false
#| message: false
#| fig-cap: "Relationship between Adult Obesity (%) and Physical Inactivity (%) across U.S. Counties (2023). Each point represents a county, and the fitted OLS line shows a strong positive association: counties with higher inactivity tend to have higher obesity prevalence."
library(ggplot2)
...
#| warning: false
#| message: false
#| fig-cap: "Residuals vs Fitted Values for the obesity ~ inactivity model. The random scatter around zero supports the linearity and constant-variance assumptions, indicating that the OLS fit is appropriate."
#| fig-pos: H
#| fig-width: 7.8
#| fig-asp: 0.62
...
#| warning: false
#| message: false
#| fig-cap: "Cook’s Distance by observation (county). All values lie well below the common influence threshold (4/n), indicating that no single county unduly affects the regression estimates."
#| fig-pos: H
#| fig-width: 7.8
#| fig-asp: 0.45
...
```{r}
#| label: tbl-model
#| tbl-cap: "Regression results estimating the association between physical inactivity and adult obesity across 3,142 U.S. counties (2023). Heteroskedasticity-consistent (HC1) standard errors are reported in parentheses."
#| tbl-pos: H
#| echo: false
#| warning: false
#| message: false
...
As shown in Table 1, the estimated linear model indicates a strong positive association between physical inactivity and adult obesity rates across U.S. counties. The slope estimate (0.71, p < 0.001) implies that each additional percentage point of physical inactivity corresponds to a 0.71 percentage-point increase in adult obesity on average. The intercept (17.8) represents the expected obesity rate for a hypothetical county with zero inactivity, and the high R² (0.63) suggests that nearly half of the variation in county obesity rates can be explained by differences in inactivity levels.
